...
- 'tests' - Unit tests for Catanatron, including new ones for our changes.
- 'ui' - The user interface for our project, which allows users to play against our bots and view game replays.