...
\begin{itemize}
  \item \label{FR.S.2.1}\textbf{FR.S.2.1} The system shall simulate the game rules, move logic, and state transitions consistent with the official \emph{\Catan{}} rule set.
...
\begin{itemize}
  ...
  \item \label{FR.S.3.4}\textbf{FR.S.3.4} The system shall win matches against a bot making random moves >50\% of the time to demonstrate learning.
  \item \label{FR.S.3.5}\textbf{FR.S.3.5} The system shall integrate with the Reinforcement Learning Environment, enabling continuous improvement.
\end{itemize}
...
\begin{itemize}
  ...
  \item \label{FR.S.4.4}\textbf{FR.S.4.4} The system shall present \LLM{}-generated move explanations clearly, with visual highlighting or overlays.
  ...
  \item \label{FR.S.4.6}\textbf{FR.S.4.6} The system shall log user interactions and decisions for post-game analysis.
  \item \label{FR.S.4.7}\textbf{FR.S.4.7} The system shall display Elo ratings and league standings for informed opponent selection.
...
\begin{itemize}
  ...
  \item \label{FR.S.5.6}\textbf{FR.S.5.6} The system shall maintain Elo ratings and match history for all league members.
  \item \label{FR.S.5.7}\textbf{FR.S.5.7} The system shall track curriculum phase progress and training metrics across runs.
\end{itemize}
...
\begin{itemize}
  \item \label{FR.S.6.1}\textbf{FR.S.6.1} The system shall enable reliable data exchange between the User Interface, Game State Manager, \AI{} model, and Database.
  \item \label{FR.S.6.2}\textbf{FR.S.6.2} The system shall support both synchronous and asynchronous message-passing mechanisms.
  \item \label{FR.S.6.3}\textbf{FR.S.6.3} The system shall ensure low-latency updates (<100ms for UI updates, <500ms for \AI{} decisions) to maintain real-time synchronization of states.
  \item \label{FR.S.6.4}\textbf{FR.S.6.4} The system shall provide secure authentication, authorization, and encryption for all transmitted data.
\end{itemize}
...
\begin{itemize}
  \item \label{FR.S.7.1}\textbf{FR.S.7.1} The system shall ensure state synchronization so the digital model matches the physical game at all times.
...
\begin{itemize}
  ...
  \item \label{FR.S.8.4}\textbf{FR.S.8.4} The system shall log generated explanations for analysis and improvement of the explanation quality over time.
\end{itemize}
...
\begin{itemize}
  ...
  \item \label{NFR.S.6}\textbf{NFR.S.6} \textbf{Availability:} The system shall recover from system failures automatically within one minute of downtime.
\end{itemize}
