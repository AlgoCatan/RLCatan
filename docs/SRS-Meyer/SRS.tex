...
\begin{itemize}
  \item \label{FR.S.8.1}\textbf{FR.S.8.1} Integrate with a large language model (LLM) to generate natural language explanations of the \AI{} agent's strategic decisions.
  \item \label{FR.S.8.2}\textbf{FR.S.8.2} Provide an API endpoint for the frontend to request explanations for specific moves or game states.
  \item \label{FR.S.8.3}\textbf{FR.S.8.3} Ensure explanations are contextually relevant, accurate, and understandable to players of varying skill levels.
  \item \label{FR.S.8.4}\textbf{FR.S.8.4} Log generated explanations for analysis and improvement of the explanation quality over time.
\end{itemize}
