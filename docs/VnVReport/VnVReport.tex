...
For our functional and non-functional requirements evaluation there were a couple bash scripts that we made for testing,
but nothing too extensive.
Many were handled manually or were already incorporated in our existing pipeline.
The CI/CD pipeline was expanded for any remaining automated test plans that were not yet implemented.
It ensures that our codebase remains stable and reliable.
This automated testing process includes running unit tests, integration tests, linting, and coverage reporting, to catch issues early in the development cycle.
